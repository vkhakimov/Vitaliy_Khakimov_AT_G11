package homework.playground.essence.runners;
...
import homework.playground.essence.processors.TransportableProcessor;
...
public class TransportableProcessorRunner {
    public static void main(String[] args) {
        ...
        AirTransport aircraftCopter = new Copter(223, "AW109 Aircraft");
        AirTransport aircraftPlane = new Plane(3452, "Airbus a380 Aircraft");
        AirTransport aircraftRocket = new Rocket(7623, "Soyuz-FG Aircraft");
...
//        We need to provide objects which implements transportable
...
//        transportableProcessor.runTransportable(rideableMotorbike);
        ...
        transportableProcessor.runTransportable(aCopter, 23, 242);
        transportableProcessor.runTransportable(aMoped, 93, 7);
